$(document).ready(function(){
  ...
  //Instantiate the button to copy words to clipboard
	...
	$("#randomizeButton").click(function(){
    	...
    	var tweetBtn = $('<a></a>').addClass('twitter-share-button').attr("href","https://twitter.com/share").attr("data-text","I used the 'Event Name Generator' by @gramercytech and got '"+eventName+"'! http://tinyurl.com/ht777r5").attr("data-hashtags",eventHashtag).html("Tweet");
